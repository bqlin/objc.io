...
+ (instancetype)contactWithRancomName{
	...
	result.name = [NSString stringWithFormat:@"%@%@", allFirstNames[arc4random_uniform((unsigned int)allFirstNames.count)], allLastNames[arc4random_uniform((unsigned int)allLastNames.count)]];
	return result;
}
